;(function () {
  ...
  SM.prototype = {
      ...
      switch (this.smpstate) {
        ...
        case CONST.SMPSTATE_EXPECT1:
          ...
          if (msg.type === 7) {
            ...
            question = msg.msg.substring(0, ind - 1)
    ...
    initiate: function (question) {
      ...
      this.sendMsg(HLP.packTLV(2, send))
    },
