;(function () {
  ...
  OTR.makeInstanceTag = function () {
    var num = parseInt(BigInt.bigInt2str(BigInt.randBigInt(32), 10), 10)
    if (num < 256) return OTR.makeInstanceTag()  // greater than \x00000100
    return HLP.packINT(num)
  }
