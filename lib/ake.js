;(function () {
  ...
  AKE.prototype = {
    ...
    handleAKE: function (msg) {
      ...
      switch (version) {
        case CONST.OTR_VERSION_3:
          debug('v3')
          if (!this.otr.ALLOW_V3) return
          var instance_tags = msg.msg.substring(0, 8)
          msg.msg = msg.msg.substring(8)
          break
        case CONST.OTR_VERSION_2:
          debug('v2')
          if (!this.otr.ALLOW_V2) return
          break
        default:
          return  // ignore
      }
    ...
    sendMsg: function (version, type, msg) {
      ...
      send = HLP.wrapMsg(send, this.otr.fragment_size)
